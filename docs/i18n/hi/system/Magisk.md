...
* **`boot_props_mode`**: बूटलोडर प्रॉपर्टी सिमुलेशन (`auto`, `manual`, या `disabled`)।
...
| `tee_broken_mode` | टूटे हुए हार्डवेयर TEE वाले उपकरणों पर सॉफ्टवेयर अटेस्टेशन फ़ॉलबैक सक्षम करता है। |
