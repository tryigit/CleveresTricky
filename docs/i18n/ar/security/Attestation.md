...
- **استعادة TEE RKP من جانب الجهاز**: كما هو موضح في [بحث wuxianlin](https://wuxianlin.com/2025/11/12/oneplus-13-15-attestation-rkp-test/) (تم اختباره على أجهزة حديثة تشمل OnePlus 13/15)، يمكن لتزويد معرّف الجهاز عبر `KmInstallKeybox` استعادة TEE RKP الأصلي (و Widevine L1 RKP) دون حقن مفاتيح مسربة. يعمل هذا كآلية استعادة شرعية لـ TEE من جانب الجهاز عبر أجهزة أندرويد غير المقفلة، وليس انتحالاً لـ Keystore أو محاكاة برمجية.
- **النطاق والتوصيات**:
