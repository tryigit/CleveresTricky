...
* **Uploads überschreiben nie:** Eine abgelegte oder eingefügte Keybox wird als `keybox.xml` gespeichert; ist dieser Name bereits belegt, wird automatisch der nächste freie Name (`keybox2.xml`, `keybox3.xml`, ...) verwendet.
