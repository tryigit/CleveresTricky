...
object TestKeyboxFixtures {
    ...
    val rkpRootKeyPair: java.security.KeyPair by lazy {
        val kpg = java.security.KeyPairGenerator.getInstance("EC")
        kpg.initialize(java.security.spec.ECGenParameterSpec("secp256r1"))
        kpg.generateKeyPair()
    }

    val rkpRootCert: java.security.cert.X509Certificate by lazy {
        ...
        val name = org.bouncycastle.asn1.x500.X500Name("CN=Key Attestation CA1, OU=Android, O=Google LLC, C=US")
        val serial = java.math.BigInteger.valueOf(1)
    ...
    val selfSignedRkpKeyboxXml: String by lazy {
        val kpg = java.security.KeyPairGenerator.getInstance("EC")
        kpg.initialize(java.security.spec.ECGenParameterSpec("secp256r1"))
    ...
    val validRkpKeyboxXml: String by lazy {
        ...
        // Intermediate cert (Droid CA2) signed by Root CA
