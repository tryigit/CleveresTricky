...
assert.deepStrictEqual(runtimeScripts, ['bridge.js', 'policy.js', 'ux-core.js', 'ux.js'], 'WebUI runtime JS layout must include the intentional ux/ux-core split');

const ux = `${fs.readFileSync(`${root}/ux.js`, 'utf8')}\n${fs.readFileSync(`${root}/ux-core.js`, 'utf8')}`;
...
assert.ok(!fs.existsSync(`${root}/ux-base.js`) && !fs.existsSync(`${root}/zip-import.js`), 'retired feature-specific runtime JS must not be reintroduced');
