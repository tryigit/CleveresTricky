...
namespace android {
    ...
    // Binder.h
    // Link-only definitions. The module package excludes this library so these
    // symbols resolve to the target process's platform libbinder at runtime.
    BBinder::BBinder() {}
    ...
    // Parcel.h
    // Link-only definitions; see the BBinder note above.
    Parcel::Parcel() {}
    Parcel::~Parcel() {}
