...
function injectStyles() {
  ...
  style.textContent = `
    ...
    input[type="checkbox"].ct-switch:checked::after{transform:translateX(20px)!important;background:#ffffff!important}
    input[type="checkbox"].ct-switch.pending-reboot,input[type="checkbox"].toggle.pending-reboot{background:#854d0e!important;border-color:#eab308!important;box-shadow:none!important}
    input[type="checkbox"].ct-switch.pending-reboot:checked,input[type="checkbox"].toggle.pending-reboot:checked{background:#d97706!important;border-color:#fbbf24!important;box-shadow:none!important}
    input[type="checkbox"].ct-switch.pending-reboot:checked::after{transform:translateX(20px)!important;background:#ffffff!important}
