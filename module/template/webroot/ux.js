(function (global) {
    ...
    Object.assign(TRANSLATIONS.tr, {
        ...
        'edit': 'Düzenle',
        'Edit': 'Düzenle',
        'add_server_btn': '+ Sunucu Ekle',
        'add_server_title': '+ Sunucu Ekle',
        'edit_server': 'Sunucuyu Düzenle',
        'save_server': 'Sunucuyu Kaydet',
        'cancel': 'İptal',
        'Cancel': 'İptal',
        'Server Updated': 'Sunucu Güncellendi',
        'Server Added': 'Sunucu Eklendi',
    ...
    const COMPLETE_CATALOG_ROWS = [
        ...
        ["edit", "编辑", "Editar", "Bearbeiten", "Редактировать", "Edit", "संपादित करें", "تعديل"],
        ["Edit", "编辑", "Editar", "Bearbeiten", "Редактировать", "Edit", "संपादित करें", "تعديل"],
        ["add_server_btn", "+ 添加服务器", "+ Añadir servidor", "+ Server hinzufügen", "+ Добавить сервер", "+ Tambah Server", "+ सर्वर जोड़ें", "+ إضافة خادم"],
        ["add_server_title", "+ 添加服务器", "+ Añadir servidor", "+ Server hinzufügen", "+ Добавить сервер", "+ Tambah Server", "+ सर्वर जोड़ें", "+ إضافة خادم"],
        ["edit_server", "编辑服务器", "Editar servidor", "Server bearbeiten", "Редактировать сервер", "Edit Server", "सर्वर संपादित करें", "تعديل الخادم"],
        ["save_server", "保存服务器", "Guardar servidor", "Server speichern", "Сохранить сервер", "Simpan Server", "सर्वर सहेजें", "حفظ الخادم"],
        ["cancel", "取消", "Cancelar", "Abbrechen", "Отмена", "Batal", "रद्द करें", "إلغاء"],
        ["Cancel", "取消", "Cancelar", "Abbrechen", "Отмена", "Batal", "रद्द करें", "إلغاء"],
        ["Server Updated", "服务器已更新", "Servidor actualizado", "Server aktualisiert", "Сервер обновлён", "Server Diperbarui", "सर्वर अपडेट हुआ", "تم تحديث الخادم"],
...
(function (global) {
    ...
    function renderPriorityOrder() {
        ...
        const hintDefault = document.getElementById('ct_keybox_priority_mode_hint');
        if (hintDefault) hintDefault.style.display = currentPriorityMode === 'custom' ? 'none' : '';
    ...
    async function loadPriorityOrder(options = {}) {
        ...
        try {
            ...
            const loadedOrder = normalizeLoadedPriorityOrder(data.customOrder);
            if (data.mode === 'custom' && loadedOrder !== null) {
                currentPriorityMode = 'custom';
                currentPriorityOrder = loadedOrder;
            } else {
